...
public class Show {
	 ...
	 * @param showName
	 * @param movieName
	 * parameterized constructor for Show 
	 */
	public Show(Integer showId, LocalTime showStartTime, LocalTime showEndTime, List<Integer> seats, String showName,
			String movieName) {
		super();
		this.showId = showId;
	...
	public String toString() {
		return " showId\t:\t" + showId + " showName\t:\t" + showName+"\n";
	}
